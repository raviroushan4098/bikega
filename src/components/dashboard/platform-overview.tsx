...
import { Youtube, MessageSquare, Twitter, Globe } from 'lucide-react';
      ...
      <CardContent>
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <span className="text-card-foreground font-medium">{youtubeCount} videos</span>
          </div>
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              {/* Using MessageSquare for Reddit as a placeholder, consider the custom RedditIcon if preferred */}
              <RedditIcon className="w-5 h-5 text-orange-500" />
              <span className="text-muted-foreground">Reddit Analytics</span>
            </div>
            <span className="text-card-foreground font-medium">{redditCount} posts</span>
          </div>
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
            ...
            <span className="text-card-foreground font-medium">{twitterCount} tweets</span>
          </div>
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
            ...
            <span className="text-card-foreground font-medium">{mentionsCount} mentions</span>
          </div>
        </div>
      </CardContent>
    </Card>
