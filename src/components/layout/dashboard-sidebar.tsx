...
// This component is no longer used in the main DashboardLayout as of the hover-nav implementation.
// It can be kept for reference or removed if the new navigation is permanent.
...
export default function DashboardSidebar() {
  ...
  // This component is not rendered by DashboardLayout anymore if HoverNavMenu is used.
  // The following return statement is for the original sidebar structure.
  return (
